...
name = quick_draw_data_set[random_number];
console.log(name);
document.getElementById("sketchtodraw").innerHTML = "Sketch: "+name;
timer_counter = 0;
timer_check = null;
drawn_sketch = null;
answer_holder = null;
...
if (drawn_sketch == name){
    answer_holder = "set";
    timer_counter++;
    document.getElementById("timelimit").innerHTML = "Timer: "+timer_counter;
